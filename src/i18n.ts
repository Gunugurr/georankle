...
export const STRINGS = {
  en: {
    ...
    matchModeTitle: 'Match-Up',
    matchModeDesc: 'Drag flags to their best category — 3 lives',
    matchHint: 'Drag each flag onto the category where it ranks best — or tap a flag, then tap a category.',
    matchWin: '🎉 Perfect match!',
    matchLose: '💔 Out of lives',
    matchSolution: 'Correct answers',
    livesLabel: 'Lives',
    statsMatch: '🧩 Match',
  ...
  tr: {
    ...
    matchModeTitle: 'Eşleştirme',
    matchModeDesc: 'Bayrağı en iyi kategorisine sürükle — 3 hak',
    matchHint: 'Her bayrağı en iyi sıralandığı kategoriye sürükle — ya da bayrağa dokunup seç, sonra kategoriye dokun.',
    matchWin: '🎉 Hepsini eşledin!',
    matchLose: '💔 Hakların bitti',
    matchSolution: 'Doğru cevaplar',
    livesLabel: 'Hak',
    statsMatch: '🧩 Eşleştirme',
